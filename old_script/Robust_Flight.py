...
class MHE:
    ...
    def MHEsolver(self, Y, x_hatmh, xmhe_traj, ctrl, model_QR, time, R_b, ref_pva, print_level=0):
        assert hasattr(self, 'state'), "Define the state variable first!"
        assert hasattr(self, 'noise'), "Define the noise variable first!"
    ...
    def GetAuxSys(self, state_traj_opt, costate_traj_opt, model_QR, Y, ref_pva):
